...
public class DocumentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        browse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ContextCompat.checkSelfPermission(DocumentsActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED){
                    selectPdf();
                } else {
                    ActivityCompat.requestPermissions(DocumentsActivity.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 9);
                }
            }
        });
        ...
        upload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(pdfUri != null){
                    firebaseStorage = storageReference.child("/Documents" + "/" + pdfUri.toString());
                    UploadTask uploadTask = firebaseStorage.putFile(pdfUri);
                    uploadTask.addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(DocumentsActivity.this, "Upload failed:" +
                    ...
                    Toast.makeText(DocumentsActivity.this, "Choose a file", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        if(requestCode == 9 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
            ...
            Toast.makeText(DocumentsActivity.this, "Please provide permission", Toast.LENGTH_SHORT);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode == 86 && requestCode == RESULT_OK){
            ...
            Toast.makeText(DocumentsActivity.this, "No file is chosen", Toast.LENGTH_SHORT).show();
        }
    }
}
